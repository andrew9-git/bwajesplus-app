...
bwajes_plus_header('post-category', 'All post categories');
...
<div class="home-content">
        ...
        <div class="card">
          <div class="card-header">
            <div class="info-container">
              <a href="post-category" class="btn btn-success">back</a>
            </div><br>
            <form action="">
                <div class="form-wrapper">
                    <div class="form-group">
                        <span><b>Total post categories - <span id="total_post_categories"></span></b></span>
                    </div>
                    <div class="search-button-wrapper">
                        <div class="form-group">
                            <input type="search" class="form-control" placeholder="search for post category here..." name="search" id="search" onkeyup="load_data(this.value);">
                        </div>
                        <!-- <div class="form-group">
          ...
          <div class="card-body">
            <table class="table table-striped table-hover">
              ...
              <tbody id="post_category_data"></tbody>
            </table>
    ...
    <script>
      ...
      function load_data(query='', page_number = 1)
      {
        ...
        form_data.append('post_category_query', query);
        ...
        xhr.onload = function()
        {
          if(this.status == 200)
          {
              ...
              document.getElementById('post_category_data').innerHTML = html;
              document.getElementById('total_post_categories').innerHTML = response.total_data;
    ...
    <?php
      if(isset($_POST['delete-post-category']))
      {
        $post_category_id = $_POST['delete-post-category'];
        $executed = delete_single_row($post_category_id, 'post_category');
        if($executed)
        {
          $url = $host . 'all-categories';
          redirect_to($url);
        }
      }
    ?>
