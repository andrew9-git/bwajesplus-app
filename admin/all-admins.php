        ...
        <div class="card">
          <div class="card-header">
              <div style="display: flex;align-items:center;justify-content:space-between;">
                <a href="register-admin" class="btn btn-success">register admin</a>
                <form action="">
          ...
          if(this.status == 200)
          {
              ...
              if(response.data.length > 0)
              {
                  for(let count = 0; count < response.data.length; count++)
                  {
                    ...
                    html += '<td><a href="admin/'+ response.data[count].admin_id +'"><i class="bx bx-link-external"></i></a>|<a href="edit-admin/'+ response.data[count].admin_id +'"><i class="bx bx-edit"></i></a></td>';
                    html += '</tr>';
                    serial_no++;
